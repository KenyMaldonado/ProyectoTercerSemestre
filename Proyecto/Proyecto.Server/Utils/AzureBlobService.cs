...
namespace Proyecto.Server.Utils
{
    public class AzureBlobService
    {
        ...
        private readonly string _containerNamePlayer;
        private readonly string _containerNameNews;
        public AzureBlobService(IConfiguration configuration)
        {
            _connectionString = configuration["AzureBlobStorage:ConnectionString"];
            _containerName = configuration["AzureBlobStorage:ContainerName"];
            _containerNameLogos = configuration["AzureBlobStorage:ContainerNameLogos"];
            _containerNamePlayer = configuration["AzureBlobStorage:ContainerNamePlayers"];
            _containerNameNews = configuration["AzureBlobStorage:ContainerNameNews"];
        }
        ...
        public async Task<string> UploadImageTeamAsync(Stream fileStream, string fileName)
        {
            try
            {
        ...
        public async Task<string> UploadImagePlayerAsync(Stream fileStream, string fileName)
        {
            try
            {
                // Verificar si el archivo tiene una extensión de imagen válida
                ...
                var blobServiceClient = new BlobServiceClient(_connectionString);
                var containerClient = blobServiceClient.GetBlobContainerClient(_containerNamePlayer);
        ...
        public async Task<string> UploadImageNewsAsync(Stream fileStream, string fileName)
        {
            try
            {
                // Verificar si el archivo tiene una extensión de imagen válida
                ...
                var blobServiceClient = new BlobServiceClient(_connectionString);
                var containerClient = blobServiceClient.GetBlobContainerClient(_containerNameNews);
