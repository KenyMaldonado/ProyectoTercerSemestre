...
const StepContent = () => {
  ...
  useEffect(() => {
    if (datosRecuperados && formData) {
      setTeamName(formData.nombreEquipo || "");
      setSelectedSubTournament(formData.subTorneoId?.toString() || "");
      setCaptain((prev) => ({
        ...prev,
        nombre: formData.nombreCapitan || "",
        apellido: formData.apellidoCapitan || "",
      }));
    }
  }, [datosRecuperados, formData]);
  ...
  return (
    <div key={stepper.current.id} className="step-form animated-form">
      <div className="form-wrapper">
              ...
              <div>
                <Form.Group className="mb-4">
                  ...
                  <Form.Text className="text-muted d-block mb-2">
                    Elige el torneo al que deseas inscribirte. Solo se mostrarán
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <Form.Group className="mb-3">
                        ...
                        <ImagenUploader
                          onImagenSeleccionada={setImagenEquipo}
                        />
                        {imagenEquipo && (
                          <div className="mt-2">
                            <img
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        ...
                        <p>
                          ...
                          {municipios.find(
                            (m) =>
                              m.municipioId === parseInt(captain.municipioId)
                          )?.nombre || "No seleccionado"}
                        </p>
                      </div>
                      <div className="col-md-4">
        ...
        <div className="d-flex justify-content-between mt-4 step-buttons">
          <Button
            variant="secondary"
...
const InscripcionTorneo = () => {
  ...
  return (
    <Scoped>
      {fase === "inicio" && (
        <Row className="inscripcion-wrapper gx-4 mt-4">
          <Col md={6} className="mb-3">
            <div className="card shadow-sm border-0">
              <div className="card-header bg-primary text-white">
                <h5 className="mb-0">Nueva inscripción</h5>
              </div>
              <div className="card-body">
                <EmailRequest
          ...
          <Col md={6} className="mb-3">
            <div className="card shadow-sm border-0">
              <div className="card-header bg-secondary text-white">
                <h5 className="mb-0">Continuar inscripción</h5>
              </div>
              <div className="card-body">
                <CodeVerification
